...
registerBlockType('tlf-plugins/image-accordion', {
    ...
    save: ({ attributes }) => {
      ...
      return (
        <div class="accordion image-accordion accordion-flush" id={"accordion" + attributes.dropdownTitle.replace(/\ /g, "")}>
            <div class="accordion-item">
                <div class="accordion-header" id={"heading-" + attributes.dropdownTitle.replace(/\ /g, "")}>
